A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get On Queue Agent Counts
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-on-queue-agent-counts-data-action-module.git?ref=v1.0.0"
    action_name        = "Get On Queue Agent Counts"
